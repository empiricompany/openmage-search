 ...
 * @author     Tony
 */
class MM_Search_Block_Adminhtml_Analytics_Queries_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * Constructor
     */
     ...
     * Prepare collection
     *
     * @return MM_Search_Block_Adminhtml_Analytics_Queries_Grid
     */
        ...
        try {
            ...
            if (!empty($collectionName)) {
                ...
                if ($engine->supportsAnalytics()) {
                    $queries = $engine->getPopularQueries($collectionName, 1000);
